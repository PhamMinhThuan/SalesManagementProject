...
IF OBJECT_ID('dbo.CTHD', 'U') IS NOT NULL 
  DROP TABLE CTHD;
...
MASP CHAR(4),
SL INT,
CONSTRAINT FK_CTHD_HOADON FOREIGN KEY (SOHD) REFERENCES HOADON(SOHD) ON DELETE CASCADE,
CONSTRAINT FK_CTHD_SANPHAM FOREIGN KEY (MASP) REFERENCES SANPHAM(MASP) ON DELETE CASCADE
)

SET DATEFORMAT DMY

-- KHÁCH HÀNG 
INSERT INTO KHACHHANG VALUES ('KH01','Nguyen Van A','731, Tran Hung Dao, Q 5, Tp HCM','08823451','22/10/1960','22/10/2006')
INSERT INTO KHACHHANG VALUES ('KH02','Tran Ngoc Han','23/5, Nguyen Trai, Q 5, Tp HCM','0908256478','03/04/1974','30/07/2006')
INSERT INTO KHACHHANG VALUES ('KH03','Tran Ngoc Linh','45, Nguyen Canh Chan, Q 1, Tp HCM','0938776266','12/06/1980','05/08/2006')
INSERT INTO KHACHHANG VALUES ('KH04','Tran Minh Long','50/34 Le Dai Hanh, Q 10, Tp HCM','0917325476','09/03/1965','02/10/2006')
INSERT INTO KHACHHANG VALUES ('KH05','Le Nhat Minh','34, Truong Dinh, Q 3, Tp HCM','08246108','10/03/1950','28/10/2006')
INSERT INTO KHACHHANG VALUES ('KH06','Le Hoai Thuong','227, Nguyen Van Cu, Q 5, Tp HCM','08631738','31/12/1981','24/11/2006')
INSERT INTO KHACHHANG VALUES ('KH07','Nguyen Van Tam','32/3, Tran Binh Trong, Q 5, Tp HCM','0916783565','06/04/1971','01/12/2006')
INSERT INTO KHACHHANG VALUES ('KH08','Phan Thi Thanh','45/2, An Duong Vuong, Q 5, Tp HCM','0938435756','10/01/1971','13/12/2006')
